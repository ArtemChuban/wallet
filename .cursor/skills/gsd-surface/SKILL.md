...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/artem/Documents/wallet/.cursor/.gsd-surface.json`
(sibling to `/home/artem/Documents/wallet/.cursor/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/artem/Documents/wallet/.cursor/skills/gsd-*/`.
...
(`/home/artem/Documents/wallet/.cursor`), NOT the skills sub-directory (`/home/artem/Documents/wallet/.cursor/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/home/artem/Documents/wallet/.cursor` as `configDir`. The skill dirs themselves live at
`/home/artem/Documents/wallet/.cursor/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Cursor — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/home/artem/Documents/wallet/.cursor}"
SCOPE="global"
...
(i.e. `/home/artem/Documents/wallet/.cursor/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/artem/Documents/wallet/.cursor/.gsd-surface.json`
Install profile marker: `/home/artem/Documents/wallet/.cursor/.gsd-profile`
Skill dirs: `/home/artem/Documents/wallet/.cursor/skills/gsd-*/`
Engine module: `/home/artem/Documents/wallet/.cursor/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/artem/Documents/wallet/.cursor/gsd-core/bin/lib/clusters.cjs`
</execution_context>
