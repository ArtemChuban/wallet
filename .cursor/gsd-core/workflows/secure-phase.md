...
```
Agent(
  prompt="Read /home/artem/Documents/wallet/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/artem/Documents/wallet/.cursor/gsd-core/templates/SECURITY.md`
