...
- **Global scope**: `/home/artem/Documents/wallet/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/artem/Documents/wallet/.cursor/notes/`)
...
2. Glob `/home/artem/Documents/wallet/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/home/artem/Documents/wallet/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/artem/Documents/wallet/.cursor/notes/` — works in any directory
