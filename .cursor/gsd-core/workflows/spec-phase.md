...
ones). Reference: @/home/artem/Documents/wallet/.cursor/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/artem/Documents/wallet/.cursor.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/artem/Documents/wallet/.cursor/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/artem/Documents/wallet/.cursor/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/artem/Documents/wallet/.cursor/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/artem/Documents/wallet/.cursor/gsd-core/templates/spec.md.
