...
- Usage: Reference from command with `@/home/artem/Documents/wallet/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/artem/Documents/wallet/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/artem/Documents/wallet/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
