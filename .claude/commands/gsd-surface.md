...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/artem/Documents/wallet/.claude/.gsd-surface.json`
(sibling to `/home/artem/Documents/wallet/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/artem/Documents/wallet/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/artem/Documents/wallet/.claude/skills`).
...
`/home/artem/Documents/wallet/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/artem/Documents/wallet/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/artem/Documents/wallet/.claude/.gsd-surface.json`
Install profile marker: `/home/artem/Documents/wallet/.claude/.gsd-profile`
Skill dirs: `/home/artem/Documents/wallet/.claude/skills/gsd-*/`
Engine module: `/home/artem/Documents/wallet/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/artem/Documents/wallet/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
