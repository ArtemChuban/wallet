...
- [ ] 05-01-PLAN.md — NW lib tracer + hero on / + nav + asset rows

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 05-02-PLAN.md — Credit rows, missing states, partial-warning callout
...
| 5. Net Worth Dashboard | 0/3 | Not started | - |
