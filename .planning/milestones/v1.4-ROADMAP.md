...
- [x] **Phase 26: Connect Docs + Policy** - Claude/Cursor connect snippets, readOnlyHint + isolation copy, PARITY-01 materialization (completed 2026-09-11)
...
- [x] 26-02-PLAN.md — CLI-01 expand: income/grace/forecast named prose + CAP polish + full mcp suite
- [x] 26-03-PLAN.md — CLI-02 README Claude/Cursor copy-paste configs after Quick start
- [x] 26-04-PLAN.md — PARITY-01 AGENTS block + PROJECT/REQUIREMENTS close-out + 26-UAT dual-client scaffold
...
| 26. Connect Docs + Policy | v1.4 | 4/4 | Complete    | 2026-09-11 |
